...
export const Wrapper = styled.button<WrapperProps>`
  ${({ theme, $iconPosition }) => css`
    ...
    align-items: center;
    border: 1px solid ${theme.colors.secondary[950]};
    ...
    cursor: pointer;
    -webkit-box-shadow: 0px 6px 1px -2px ${theme.colors.secondary[950]};
    -moz-box-shadow: 0px 6px 1px -2px ${theme.colors.secondary[950]};
    box-shadow: 0px 6px 1px -2px ${theme.colors.secondary[950]};
    transition: 0.1s;
